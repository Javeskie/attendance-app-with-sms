...
class StudentLog:
    def __init__(self, master):
        ...
        self.master.geometry("1280x800")  # Set window size to 1920x1080
    ...
    def create_second_page(self, result, comparison_results):
        ...
        if instructors_data:
            ...
            instructor_options = ["Instructor 1", "Instructor 2", "Instructor 3"]  # Default options if fetching fails
        ...
        exit_button_image = Image.open("exitbutton.png")
        ...
        submit_button_image = Image.open("submitbutton.png")
        ...
        #Backspace Button
        backspace_button_path = "backspace.png"
    ...
    def go_to_last(self):
        ...
        statement = Image.open("statement.png")
